...
public class Test {
	...
	protected static final int OVER_PRODUCTION = 2;
	protected static final int MIXING = 3;
	protected static final int[] supportedAdultSelectionMode = {FULL, OVER_PRODUCTION, MIXING}; //Must be sorted
	
	protected static final int FITNESS_PROPORTIONATE = 1;
	protected static final int SIGMA_SCALING = 2;
	protected static final int RANK = 3;
	protected static final int TOURNAMENT = 4;
	protected static final int[] supportedParentSelectionMode = {FITNESS_PROPORTIONATE, SIGMA_SCALING, RANK, TOURNAMENT}; //Must be sorted
